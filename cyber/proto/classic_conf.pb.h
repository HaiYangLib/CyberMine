...
inline std::string* SchedGroup::release_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = name_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
  return p;
}
...
inline std::string* SchedGroup::release_processor_policy() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = processor_policy_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (processor_policy_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    processor_policy_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
