...
_SHMCONF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shm_locator', full_name='apollo.cyber.proto.ShmConf.shm_locator', index=1,
